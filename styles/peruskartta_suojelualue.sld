    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <PolygonSymbolizer uom="http://www.opengeospatial.org/se/units/metre"> <!-- draw the intersection of the original geometry and the offset geometry with a green ouline and a green fill -->
             <Geometry>
